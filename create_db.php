...
$sql = "CREATE TABLE IF NOT EXISTS blocked_users (
    ...
    FOREIGN KEY (blocker_id) REFERENCES userstable(id) ON DELETE CASCADE,
    FOREIGN KEY (blocked_id) REFERENCES userstable(id) ON DELETE CASCADE,
    UNIQUE (blocker_id, blocked_id)
)";
if ($conn->query($sql) === TRUE) {
    echo "Table 'blocked_users' created successfully.<br>";
} else {
    echo "Error creating table 'blocked_users': " . $conn->error;
}
